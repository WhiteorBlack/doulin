package com.lixin.amuseadjacent.zxing.activity;
...
import com.lixin.amuseadjacent.zxing.camera.CameraManager;
import com.lixin.amuseadjacent.zxing.decoding.CaptureActivityHandler;
import com.lixin.amuseadjacent.zxing.decoding.InactivityTimer;
import com.lixin.amuseadjacent.zxing.decoding.RGBLuminanceSource;
import com.lixin.amuseadjacent.zxing.view.ViewfinderView;
...
public class CaptureActivity extends AppCompatActivity implements Callback {
    ...
    private TextView tv_flashlight;//打开手电筒
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT > 19) {
            StatusBarUtil.setColorNoTranslucent(this, getResources().getColor(R.color.ssss));
        }

        tv_flashlight = findViewById(R.id.tv_flashlight);
        tv_flashlight.setOnClickListener(view -> {
